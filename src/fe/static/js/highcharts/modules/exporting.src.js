...
(function(factory) {
    ...
    (function(H) {
        ...
        extend(Chart.prototype, /** @lends Highcharts.Chart.prototype */ {
            ...
            /**
             * Exporting model required. Submit an SVG version of the chart to a server
             ...
             *         The URL for the server model to do the conversion.
            ...
            /**
             * Exporting model required. Clears away other elements in the page and
             * prints the chart as it is displayed. By default, when the exporting
             * model is enabled, a context button with a drop down menu in the upper
