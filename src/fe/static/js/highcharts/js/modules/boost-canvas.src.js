...
(function(factory) {
    ...
    (function(H) {
         ...
         * 
         * This is an experimental Highcharts model that draws long data series on a canvas
         ...
         * Development plan
         * - Column range.
         * - Heatmap. Modify the heatmap-canvas demo so that it uses this model.
         * - Treemap.
         ...
         *
         * If this model is taken in as part of the core
            ...
            H.extend(Series.prototype, {
                ...
                renderCanvas: function() {
                    ...
                    eachAsync(sdata, function(d, i) {
                        ...
                        // CSS animation looks good, but then it must be deleted in timeout. If we add the model to core,
